...
namespace MAPapp
{
	public class AccountSettings : ContentPage
	{
...

        {
                ...
                grid1.Children.Add(naamlabel = new Label() { Text = "Naam: ", FontSize = 20 }, 0, 0);
                grid1.Children.Add(achternaamlabel = new Label() { Text = "Achternaam: ", FontSize = 20 }, 0, 1);
                grid1.Children.Add(bedrijflabel = new Label() { Text = "Bedrijf: ", FontSize = 20 }, 0, 2);
                grid1.Children.Add(emaillabel = new Label() { Text = "Email:", FontSize = 20 }, 0, 3);
                ...
                grid1.Children.Add(veranderWachtwoord = new ClickableLabel(veranderwachtwoord) { Text = "verander wachtwoord", TextColor = Color.Aqua }, 0, 4);
                grid1.Children.Add(veranderEmail = new ClickableLabel(veranderemail) { Text = "verander email", TextColor = Color.Aqua, }, 0, 5);
            ...
            {
                await Navigation.PushAsync(new NewEmail());
            }
            
            // ga naar NewWachtwoord page
            public async void veranderwachtwoord(string s)
            {
                await Navigation.PushAsync(new NewWachtwoord());
            }
        }
}
